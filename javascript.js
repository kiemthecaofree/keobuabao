...
const loss = [
    "Gà quá", "Dễ win thế mà cũng không win được", "HaHa win đâu dễ", "Ngon thì win đi đâu dễ", "Win hộ cái", "Ngọc đẹp trai", "Vào kiemthecao.com lấy hên đi"];
const wins = [
    "Gà quá mãi mới win", "Hên thôi bạn ơi", "Win được ván chứ mấy", "Ngon thì win tiếp đi", "Wow. Thông minh đấy"];
// Remove Active
...
function clearActive() {
    ...
    result.innerHTML = "Thua nhiều quá xong xóa dữ liệu à!"
    setTimeout(() =>{
        result.innerHTML = "Bạn nghĩ bạn có thể thắng tôi"
    },1000);
}
